...
class CANMaster:
    ...
    def report_bit_error(self, sender_slave_id: int, offender: str = "unknown"):
        ...
        # CORREZIONE: TUTTE le ECU coinvolte nella trasmissione incrementano TEC di +8
        self._error_senders = list(set(list(self._contenders) + list(self._active_senders)))
        
        print(f"[MASTER] ECU coinvolte nell'errore: {', '.join([self.slaves[sid].name for sid in self._error_senders])}")
        
        # TUTTE le ECU coinvolte incrementano TEC di +8
        ...
        # Incrementa REC per gli altri nodi ERROR_ACTIVE che NON sono coinvolti
        ...
        # ERROR_ACTIVE: 6 bit DOMINANT
        # ERROR_PASSIVE: 8 bit RECESSIVE
    ...
    def _handle_idle(self):
        # CORREZIONE CRITICA: Raccoglie TUTTE le richieste pending e inizia SUBITO l'arbitraggio
        ...
        # Prepara tutte le ECU per l'arbitraggio
        ...
        print(f"\n[MASTER] IDLE->ARBITRATION | Contenders: {names}")
