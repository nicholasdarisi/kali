...
class CANMaster:
    ...
    def _handle_error_flag_step(self):
        ...
        if active_senders:
            ...
            if self._sockcan is not None and not self._err_active_sent:
                for sid in active_senders:  # lista delle ECU che stanno mandando l'active error flag
                    sockcan_send_error_active(self._sockcan, self.slaves[sid].name, offender_code=1)
